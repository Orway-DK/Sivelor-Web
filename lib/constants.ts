...
export const MACHINE_LIMITS = {
  none: null,
  summa: {
    markerSize: 4, // 4mm Kareler
    lineThickness: 1.0, // Alt çizgi kalınlığı
    // STATİK DEĞERLER (Kağıt kenarından uzaklıklar)
    staticBottom: 5, // Alt kenardan 5mm yukarıda başlar
    staticSide: 10, // Yanlardan 10mm içeride (Sabit)
    staticTop: 10 // Üstten 10mm içeride (Sabit)
  },
  plotter: {
    markerRadius: 3.0, // 5mm Yarıçap
    centerOffset: 10 // Merkez noktası köşeden 10mm (1cm) içeride
  }
}
